...
#Region "Identify And Create New Terminals"
    ...
    Public Function WebMethodIdentifyTerminal(ByVal AId As String, ByVal IdentifyCode As String) As Int16
        Try
            ...
            da.SelectCommand.Connection = New SqlClient.SqlConnection(GetTDBServerConnectionString)
            ds.Tables.Clear()
...
#Region "Reporting"
    ...
    Public Function WebMethodGetTruckTrace(ByVal AId As String, ByVal Pelak As String, ByVal Serial As String, ByVal TotalRec As Int16, ByRef Data As DataSet) As TruckTrace
        Try
            ...
            If ExistTruck(Pelak, Serial, New SqlClient.SqlConnection(TWSClassDatabaseManagement.GetTDBServerConnectionString), myTruckid) = False Then
    ...
    Public Function WebMethodGetLastNobatInOnlineifExist(ByVal AId As String, ByVal Pelak As String, ByVal Serial As String, ByVal TerminalID As Int16, ByRef NobatDateTime As DateTime) As Boolean
        Try
            ...
            End If
            Dim myTruckId As Int16
            If TWSClassLibrary.TrucksManagement.TWSClassTrucksManagement.ExistTruck(Pelak, Serial, New SqlClient.SqlConnection(TWSClassDatabaseManagement.GetTDBServerConnectionString), myTruckId) = False Then
                Return False
            Else
                Dim Da As New SqlClient.SqlDataAdapter : Dim Ds As New DataSet
...
#Region "Date And Time"
    ...
    Public Function WebMethodCurrentShamsiDate() As String
        Try
            Return GetCurrentShamsiDate(GetTDBServerConnectionString)
        Catch ex As Exception
...
#Region "DelNobatBarnamehOnLine And DelNobatUserRequest"
    ...
    Public Sub WebMethodDelNobatBarnameOnline(ByVal AId As String, ByVal TerminalID As Int16, ByVal SyncTerminalID As Int16, ByVal Pelak As String, ByVal Serial As String)
        ...
        CmdSql.Connection = New SqlClient.SqlConnection(GetTDBServerConnectionString)
        Try
            If MClassAuthenticationManagement.IsAuthenticationIdValid(AId) = False Then Exit Sub
            Dim myTruckId As Int16
            If TWSClassLibrary.TrucksManagement.TWSClassTrucksManagement.ExistTruck(Pelak, Serial, New SqlClient.SqlConnection(GetTDBServerConnectionString), myTruckId) = False Then
            ...
            Else
                ...
                CmdSql.ExecuteNonQuery()
                Dim mySyncDS As DataSet = GetTerminalsIDList(TerminalID, GetTDBServerConnectionString)
    ...
    Public Sub WebMethodDelNobatUserRequest(ByVal AId As String, ByVal TerminalID As Int16, ByVal SyncTerminalID As Int16, ByVal Pelak As String, ByVal Serial As String)
        ...
        Try
            ...
            Else
                ...
                CmdSql.CommandText = "delete TblNobats Where (TruckId=" & myTruckId & ") and (TerminalId =" & SyncTerminalID & ") and (TravelTime=0)"
                CmdSql.ExecuteNonQuery()
                Dim mySyncDS As DataSet = GetTerminalsList(GetTDBServerConnectionString)
                For loopDelToSync As Int16 = 0 To mySyncDS.Tables(0).Rows.Count - 1
    ...
    <WebMethod()> _
    Public Function WebMethodTrucksExist(ByVal AId As String, ByVal Pelak As String, ByVal Serial As String, ByRef Truckid As Int16) As Boolean
        If MClassAuthenticationManagement.IsAuthenticationIdValid(AId) = False Then Exit Function
        Try
            If TWSClassLibrary.TrucksManagement.TWSClassTrucksManagement.ExistTruck(Pelak, Serial, New SqlClient.SqlConnection(GetTDBServerConnectionString), Truckid) = False Then
                Return False
            Else
                Return True
            End If
        Catch ex As Exception
            EventLog.WriteEntry("TWSServerSource", "TerminalsWebService.WebMethodTrucksExist()." + ex.Message.ToString, EventLogEntryType.Error)
            LoggingMessageSabt(Logging.ErrorLog, LogSource.ServerWebService, Database.None, "", 0, "", "WebMethodTrucksExist", False, AId, ACKSignal.NoneOrMsg, Nothing, MClassSystemStatusManagement.GetSystemStatus, 0, ex.Message.ToString)
            Throw New Exception("TerminalsWebService.WebMethodTrucksExist()." + ex.Message.ToString)
        End Try
    End Function
